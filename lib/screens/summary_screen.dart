                      ...
                      Container(
                        ...
                        child: Text(p.$2,
                            style: AppTextStyles.caption.copyWith(
                                color: p.$4, fontWeight: FontWeight.w600)),
                      ),
                      const SizedBox(width: 12),
                      Text('${p.$3}%',
                          style: AppTextStyles.caption.copyWith(
  ...
  Widget _buildRecentActivity() {
    final activities = [
      (
        Icons.check_circle_rounded,
        const Color(0xFF22C55E),
        'Finance Module marked as complete',
        '2 hours ago'
      ),
      (
        Icons.person_add_rounded,
        AppColors.primaryPurple,
        'New employee Rohan Gupta added',
        '5 hours ago'
      ),
      (
        Icons.warning_rounded,
        const Color(0xFFEF4444),
        'Marketing Campaign deadline missed',
        'Yesterday'
      ),
      (
        Icons.edit_rounded,
        const Color(0xFFF59E0B),
        'CRM Integration progress updated to 60%',
        '2 days ago'
      ),
      (
        Icons.event_rounded,
        AppColors.primaryPurple,
        'Team meeting scheduled for 30 Jun',
        '3 days ago'
      ),
    ];
